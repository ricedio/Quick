...
import com.quick.core.viewInflater;
...
public class LuaAdapter extends BaseAdapter implements Filterable {
    ...
    private viewInflater loadlayout;
    ...
    public LuaAdapter(LuaContext context, LuaTable data, LuaTable layout) throws LuaError {
        ...
        mData = data;
        mBaseData = mData;
        loadlayout = new viewInflater(context.getContext());
        loadlayout.load(mLayout);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LuaTable hm = (LuaTable) mData.get(position + 1);
