...
import com.quick.weiget.luaeditor.LuaLexer;
import com.quick.weiget.luaeditor.LuaTokenTypes;
...
public class Lexer {
    ...
    private class LexThread extends Thread {
        ...
        public void run() {
            if(BuildConfig.DEBUG)
                Log.i("luaj", "lexerrun: start" + this);
            rescan = false;
            _abort.clear();
            try {
            ...
            if (rescan) {
                new LexThread(_lexManager).start();
            }
        }
